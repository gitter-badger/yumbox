...
dashboard =
  js: [
    ...
    '/assets/dashboard/js/modules/daily_meal/init.js'
    ...
    '/assets/dashboard/js/modules/daily_meal/controllers/index.js'
    '/assets/dashboard/js/modules/daily_meal/controllers/form.js'
    '/assets/dashboard/js/modules/daily_meal/routes.js'
